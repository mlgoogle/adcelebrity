...
import com.cloudTop.starshare.ui.main.activity.RecordVideoActivity1;
import com.cloudTop.starshare.ui.main.adapter.VideoAskAdapter;
...
public class VideoAskFragment extends BaseFragment implements SwipeRefreshLayout.OnRefreshListener, BaseQuickAdapter.RequestLoadMoreListener {
    ...
    public static final int SELF_WATCH_TYPE=2;
