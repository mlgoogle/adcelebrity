...
import com.cloudTop.starshare.bean.ActionItem;
...
import static com.cloudTop.starshare.R.id.commentList;
                    ...
                    public void onItemClick(int commentPosition) {
                        ...
                        if (0 == commentItem.getDirection()) {//只有是用户的评论明星才能回复
                            ...
                            if (presenter != null) {
                                ...
                                config.user_name = circleItem.getComment_list().get(commentPosition).getUser_name();
