...
import com.cloudTop.starshare.bean.User;
...
//	 * @return
//
	public static CircleFriendBean.CircleListBean.CommentListBean createPublicComment(String content,String Symbol_name,String User_name,long uid){
...
//	 * @return
//
	public static CircleFriendBean.CircleListBean.CommentListBean createReplyComment(String content,String Symbol_name,String username,long uid){
		CircleFriendBean.CircleListBean.CommentListBean item = new CircleFriendBean.CircleListBean.CommentListBean();
		item.setDirection(1);
		item.setUser_name(username);
		item.setUid(uid);
