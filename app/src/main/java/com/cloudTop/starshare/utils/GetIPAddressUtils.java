...
import com.cloudTop.starshare.bean.MyAddressBean;
import com.cloudTop.starshare.bean.MyIpBean;
...
public class GetIPAddressUtils {
    public static MyAddressBean getIpAddress() {
        ...
        try {
            String myIp = IPHttpUtils.request("http://ip.chinaz.com/getip.aspx").get();
            LogUtils.loge(myIp);
            ...
            if (!TextUtils.isEmpty(myIpBean.getIp())){
                ...
                String myAddress = IPHttpUtils.request(ipUrl).get();
