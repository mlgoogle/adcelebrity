package com.yundian.celebrity.ui.wangyi.session.fragment;
...
public class TeamMessageFragment extends MessageFragment {
    ...
    public boolean isAllowSendMessage(IMMessage message) {
        if (team == null || !team.isMyTeam()) {
            Toast.makeText(getActivity(), com.netease.nim.uikit.R.string.team_send_message_not_allow, Toast.LENGTH_SHORT).show();
            return false;
        }
