package com.yundian.celebrity.ui.wangyi.session.activity;
...
public abstract class BaseMessageActivity extends UI {
    ...
    private void addRightCustomViewOnActionBar(UI activity, List<SessionCustomization.OptionsButton> buttons) {
        ...
        LinearLayout view = (LinearLayout) LayoutInflater.from(activity).inflate(com.netease.nim.uikit.R.layout.nim_action_bar_custom_view, null);
        ...
        for (final SessionCustomization.OptionsButton button : buttons) {
            ...
            imageView.setBackgroundResource(com.netease.nim.uikit.R.drawable.nim_nim_action_bar_button_selector);
